...
public class OrderServiceImpl2018 implements OrderServiceAPI {
    ...
    // 创建新的订单
    @Override
    public OrderServiceVO saveOrderInfo(
        ...
        if(insert>0){
            // 返回查询结果
            OrderServiceVO orderVO = moocOrder2018TMapper.getOrderInfoById(uuid);
    ...
    public Page<OrderServiceVO> getOrderByUserId(Integer userId,Page<OrderServiceVO> page) {
        ...
        if(userId == null){
            ...
            List<OrderServiceVO> ordersByUserId = moocOrder2018TMapper.getOrdersByUserId(userId,page);
    ...
    public OrderServiceVO getOrderInfoById(String orderId) {
        OrderServiceVO orderServiceVO=moocOrder2018TMapper.getOrderInfoById(orderId);
