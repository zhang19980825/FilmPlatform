...
public class DefaultAliPayServiceImpl implements AliPayServiceAPI {
    ...
    public String trade_precreate(String orderId) {
        String filePath = "";
        // 获取订单信息
        OrderServiceVO orderVO = orderServiceAPI.getOrderInfoById(orderId);
        ...
        String operatorId = "zhangyang";

        // (必填) 商户门店编号，通过门店号和商家后台可以配置精准到门店的折扣信息，详询支付宝技术支持
        String storeId = "zhangyang";
...
//        goodsDetailList.add(goods2);
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                filePath = String.format("C:/Users/1270089912/Desktop/qrcode/qr-%s.png",
